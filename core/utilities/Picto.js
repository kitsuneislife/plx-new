...
Canvas.registerFont('./appRoot/v7/resources/fonts/Quicksand.ttf', { family: 'Quicksand' });
Canvas.registerFont('./appRoot/v7/resources/fonts/DXLBaB.ttf', { family: 'DX아기사랑B' });
Canvas.registerFont('./appRoot/v7/resources/fonts/CLR.otf', { family: 'Corporate Logo Rounded' });
Canvas.registerFont('./appRoot/v7/resources/fonts/PantonLight.otf', { family: 'Panton' });
Canvas.registerFont('./appRoot/v7/resources/fonts/PantonBlack.otf', { family: 'Panton Black' });
Canvas.registerFont('./appRoot/v7/resources/fonts/PantonBlackItalic.otf', { family: 'Panton Black Italic Caps' });
Canvas.registerFont('./appRoot/v7/resources/fonts/AvenirNextRoundedBold.ttf', { family: 'AvenirNextRoundedW01-Bold' });
...
module.exports = {
  ...
  tag: function tag(ctx, text, font = "14px", color = "#b4b4b8", stroke) {
    ...
    if (stroke) {
      ...
      c.strokeText(text, offsetX + stroke.line / 2, H + stroke.line / 2);
    }
    c.fillStyle = color;
    c.fillText(
      text, 
      offsetX + (stroke ? stroke.line / 2 : 0), 
