...
declare class KanyonEmoji extends String {
  constructor(identifier: string, fallback?: KanyonEmoji);
  reaction: string;
  no_space: string;
  name: string;
  id: string;
...
declare global {
  ...
  export const Kanyon: CommandClient;
  // gearbox
  ...
  export const _emoji: ((E: string, F?: KanyonEmoji) => KanyonEmoji);
